...
if (all_CAD_Captures_Id.indexOf('/>') != (-1)) {
...
{
if (CAD_Capture_array[i].indexOf('/>') != (-1) ){
...
if (Current_CAD_View_children_List_Name.lastIndexOf('/>') != (-1)) {
...
if (CAD_View_children_Name_bis[z].indexOf('/>') != (-1)) {
